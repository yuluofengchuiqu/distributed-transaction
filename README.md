...
- 事务满足持久化是为了能应对系统崩溃的情况。
  ...
  ![数据库ACID](F:\distributed-transaction\数据库ACID.png)
  ...
  ![数据库事务](F:\distributed-transaction\数据库事务.png)
  ...
  **分布式事务指的是事务操作跨越多个节点，并且要求满足事务的 ACID 特性。**
  ...
  ![20220512194132](F:\distributed-transaction\20220512194132.png)

  上图中包含了库存和订单两个独立的微服务，每个微服务维护了自己的数据库。在交易系统的业务逻辑中，一个商品在下单之前需要先调用库存服务，进行扣除库存，再调用订单服务，创建订单记录。

  ![20220512194149](F:\distributed-transaction\20220512194149.png)
  ...
  **情况 2，当任何阶段 1 一个参与者反馈 no，中断事务**。
  ...
  ![20200205154145](F:\distributed-transaction\20200205154145.png)
  ...
  **情况 1：阶段 1 所有参与者均反馈 yes，参与者预执行事务**。
  ...
  ![20200205180242](F:\distributed-transaction\20200205180242.png)
...
![20200205205117](F:\distributed-transaction\20200205205117.png)
...
![20200205180425](F:\distributed-transaction\20200205180425.png)
...
![20200205180515](F:\distributed-transaction\20200205180515.png)
...
![20200205205200](F:\distributed-transaction\20200205205200.png)
...
![20200205205221](F:\distributed-transaction\20200205205221.png)
...
![20220512194208](F:\distributed-transaction\20220512194208.png)
...
**正常情况——事务主动方发消息** 这种情况下，事务主动方服务正常，没有发生故障，发消息流程如下：![20220512194221](F:\distributed-transaction\20220512194221.png)
...
![20220512194230](F:\distributed-transaction\20220512194230.png)
